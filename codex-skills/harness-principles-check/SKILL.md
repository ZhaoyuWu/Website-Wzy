---
name: harness-principles-check
description: Audit implementation against principles and report violations with actionable fixes. Use when user asks for /principles-check, principles-check workflow, or equivalent role-based execution.
---
