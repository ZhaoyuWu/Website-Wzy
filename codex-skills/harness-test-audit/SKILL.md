---
name: harness-test-audit
description: Audit test quality and coverage, then identify missing critical cases. Use when user asks for /test-audit, test-audit workflow, or equivalent role-based execution.
---
