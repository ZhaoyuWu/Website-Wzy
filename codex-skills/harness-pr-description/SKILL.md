---
name: harness-pr-description
description: Generate a standalone pull request description from workflow state, evidence, and handovers. Use when user asks for /pr-description, pr-description workflow, or equivalent role-based execution.
---
...
2. Read generator$harness-evaluator/public handovers.
