...
description: Set role to producer, sync git, read task first, freeze scope, and prepare implementation context. Use when user asks for /generator, generator workflow, or equivalent role-based execution.
---
