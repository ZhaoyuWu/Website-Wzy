---
name: harness-public-handover
description: Publish shared summary only after all audit preconditions pass and no open P0/P1 findings remain. Use when user asks for /public-handover, public-handover workflow, or equivalent role-based execution.
---
...
```md
## Source Files
- handover/local$harness-generator.md
- handover/local$harness-evaluator.md
