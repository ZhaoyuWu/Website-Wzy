...
description: Start a session by loading context, constraints, and current workflow state. Use when user asks for /kickoff, kickoff workflow, or equivalent role-based execution.
---
