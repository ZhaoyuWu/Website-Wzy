---
name: harness-read-handover
description: Load local and public handover files and summarize decisions, risks, and pending work. Use when user asks for /read-handover, read-handover workflow, or equivalent role-based execution.
---
...
1. Read `handover/local$harness-generator.md`.
2. Read `handover/local$harness-evaluator.md`.
