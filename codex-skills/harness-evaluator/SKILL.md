...
description: Set role to auditor, read task first, audit in order, classify P0/P1/P2, and output go/no-go. Use when user asks for /evaluator, evaluator workflow, or equivalent role-based execution.
---
