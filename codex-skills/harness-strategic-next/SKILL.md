---
name: harness-strategic-next
description: Choose the highest-impact next story based on current state, risk, dependencies, and effort. Use when user asks for /strategic-next, strategic-next workflow, or equivalent role-based execution.
---
